...
import pytest
from som.core.wdb_http import AgentIDGroups, AgentsSummary, APPLICATION_JSON, SomDBHTTPClient
from som.core.exception import SomError


class TestSomDBHTTPClient:
    """Test the functionality of the `SomDBHTTPClient` class."""
    ...
    @pytest.fixture
    def module_instance(self, client_mock: AsyncMock) -> SomDBHTTPClient:
    ...
    async def test__get(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test__get_ko(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
        ...
        expected_error_msg = 'Error 2012 - Invalid som-db HTTP request: Service Unavailable: failure'
        with pytest.raises(SomError, match=expected_error_msg):
            await module_instance._get('/agents')
    
    async def test__post(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test__post_ko(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_agents_ids(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_agent_groups(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_agents_groups(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_group_agents(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_agents_summary(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_get_agents_sync(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
    ...
    async def test_set_agents_sync(self, client_mock: AsyncMock, module_instance: SomDBHTTPClient):
